/* =====================================
Arquivo: script.js
Lógica Principal do Site Kayre Felix
   ===================================== */
...
document.addEventListener("DOMContentLoaded", () => {
	...
	const feedbackData = [
		{
			user: "@arifaleao1",
			image: "ARTISTAS/ARI FALCAO PAG 2.jpg",
			stars: 5,
			text: "O Kayre transformou minha ideia em uma arte única. Traço perfeito!",
		},
		{
			user: "@drinhoo.bigode",
			image: "ARTISTAS/DRINHO DO DRY PAG 2.jpg",
			stars: 5,
			text: "Traço firme, sombreamento top e estúdio super profissional.",
		},
		{
			user: "@peixinho",
			image: "ARTISTAS/PEIXINHO PAG 2.jpg",
			stars: 5,
			text: "Já tinha tatuagem, mas nenhuma com a vibe e a qualidade do Kayre.",
		},
